//14051012 도진우 Traffic light for Arduino
#ifndef TIMERONE_h
#define TIMERONE_h
...
LiquidCrystal lcd(10,9,8,7,6,5); //lcd 매핑

volatile bool autoMode = false; //신호등 자동모드 설정
String str_auto = "Auto mode  ";
String str_menual = "Manual mode  ";

//신호 대기시간 지정
const int delay_blue = 1000;
const int delay_orange = 200;
const int delay_red = 1000;
